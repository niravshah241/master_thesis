function [tria_index,local_edge_index,a_index, b_index, local_vertex_index] = tria_edge_index_neumann( grid )
%TRIA_EDGE_INDEX Summary of this function goes here: TODO
%   Detailed explanation goes here: TODO

[tria_index,local_vertex_index]=find(grid.NBI==-2);


tria_index=tria_index'; %transposed only to print better on screen
local_vertex_index=local_vertex_index';

if ~isempty(tria_index)
