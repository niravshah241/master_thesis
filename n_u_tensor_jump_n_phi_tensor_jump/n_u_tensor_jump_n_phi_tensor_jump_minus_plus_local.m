function [ res ] = n_u_tensor_jump_n_phi_tensor_jump_minus_plus_local( llcoord,...
...
if tria_index_neighbour > 0
    ...
    %velocity_basis_neighbour_theory = reshape(velocity_basis_neighbour,...
