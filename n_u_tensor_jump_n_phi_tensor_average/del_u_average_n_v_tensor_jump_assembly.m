function [res] = del_u_average_n_v_tensor_jump_assembly...
    (grid,params,qdeg)
...
res_plus_plus=zeros(params.ndofs);
res_plus_minus=zeros(params.ndofs);
res_minus_plus=zeros(params.ndofs);
res_minus_minus=zeros(params.ndofs);
...
for i=1:1:length(tria_index)
    res_plus_plus(gids_velocity(tria_index(i),:),gids_velocity(tria_index(i),:))...
        =res_plus_plus(gids_velocity(tria_index(i),:),gids_velocity(tria_index(i),:))+...
        del_u_average_n_v_tensor_jump_plus_plus_integral...
...
for i=1:1:length(tria_index)
    ...
    if tria_index_neighbour>0
        res_plus_minus(gids_velocity(tria_index_neighbour,:),gids_velocity(tria_index(i),:))...
            =res_plus_minus(gids_velocity(tria_index_neighbour,:),gids_velocity(tria_index(i),:))+...
            del_u_average_n_v_tensor_jump_plus_minus_integral...
            (params,grid,tria_index(i),local_vertex_index(i),qdeg);
    end
end
...
for i=1:1:length(tria_index)
    ...
    if tria_index_neighbour>0
        res_minus_plus(gids_velocity(tria_index(i),:),gids_velocity(tria_index_neighbour,:))...
            =res_minus_plus(gids_velocity(tria_index(i),:),gids_velocity(tria_index_neighbour,:))+...
            del_u_average_n_v_tensor_jump_minus_plus_integral...
            (params,grid,tria_index(i),local_vertex_index(i),qdeg);
    end
end
...
for i=1:1:length(tria_index)
    ...
    if tria_index_neighbour>0
        res_minus_minus(gids_velocity(tria_index_neighbour,:),gids_velocity(tria_index_neighbour,:))...
            =res_minus_minus(gids_velocity(tria_index_neighbour,:),gids_velocity(tria_index_neighbour,:))+...
            del_u_average_n_v_tensor_jump_minus_minus_integral...
            (params,grid,tria_index(i),local_vertex_index(i),qdeg);
    end
end
