...
params.xrange = [0,1];
params.yrange = [0,1];
params.xnumintervals = 24;
params.ynumintervals = 9;
params.bnd_rect_corner1=[-1,-1;1-eps,5*10^14*eps]';
...
paramsP.dof_analytical = @(glob) (2*params.kinematic_viscosity(params))*(1-glob(1));
