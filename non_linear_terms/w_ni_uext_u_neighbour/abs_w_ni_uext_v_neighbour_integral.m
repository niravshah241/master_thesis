function [ res ] = abs_w_ni_uext_v_neighbour_integral(params, paramsP,...
    grid, tria_index, local_vertex_index, qdeg)
%ABS_W_NI_UEXT_V_NEIGHBOUR_INTEGRAL Summary of this function goes here
%   Detailed explanation goes here

f = @(llcoord) abs_w_ni_uext_v_neighbour_local( llcoord, params, paramsP,...
