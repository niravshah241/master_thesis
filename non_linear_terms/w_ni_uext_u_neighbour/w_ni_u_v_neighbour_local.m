function [ res ] = w_ni_u_v_neighbour_local( llcoord, params,...
    paramsP, grid, tria_index, local_vertex_index)
%W_NI_U_V_NEIGHBOUR_LOCAL Summary of this function goes here
